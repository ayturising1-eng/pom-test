(function () {
  ...
  function setupPwaInstall() {
    ...
    if ('serviceWorker' in navigator) {
      window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=8.9.4').catch(() => {}), { once: true });
    }
  }
